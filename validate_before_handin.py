...
def build_student_feedback_file(user_name, student_record, programs_to_submit, programs_prefix, tour_files_to_submit,
    ...
    f = open(user_name + "_feedback.txt", "w")
...
if flag[1] != 0:
    print("*** error: there is something wrong with " + alg_codes_file)
    sys.exit()

if not os.path.isdir(user_name):
    print("*** error: the folder " + user_name + " does not exist.")
    sys.exit()
student_record = {}
